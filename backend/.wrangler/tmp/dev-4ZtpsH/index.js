...
// .wrangler/tmp/bundle-SGwvia/checked-fetch.js
...
// .wrangler/tmp/bundle-SGwvia/middleware-loader.entry.ts
init_checked_fetch();
init_modules_watch_stub();

// .wrangler/tmp/bundle-SGwvia/middleware-insertion-facade.js
init_checked_fetch();
init_modules_watch_stub();
...
app.post("/api/v1/user/signin", async (c) => {
  ...
  try {
    ...
    if (!user) {
      c.status(403);
      return c.text("Incorrect credentioals");
    }
  } catch (err) {
    c.status(411);
